...
import com.example.llegadasegura.databinding.ActivityTerminosResultinfoBinding
import com.example.llegadasegura.principal.PrincipalActivity
import com.example.llegadasegura.registro.MainActivity


class TerminosResultActivityInfo : AppCompatActivity() {
    private lateinit var binding: ActivityTerminosResultinfoBinding

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTerminosResultinfoBinding.inflate(layoutInflater)
