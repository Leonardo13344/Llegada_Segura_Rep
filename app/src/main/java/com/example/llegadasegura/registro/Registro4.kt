...
class Registro4: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnContinuar.setOnClickListener{
            if (validarContraseña(contrasenia.text.toString())){
                ...
                Toast.makeText(this,"La contraseña tiene que ser +8 Caracteres", Toast.LENGTH_LONG)
            }
    ...
    private fun validarContraseña(contrasenia:String):Boolean {
